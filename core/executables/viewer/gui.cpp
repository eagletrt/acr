...
bool GUI::setup() {
  ...
  window_ =
      glfwCreateWindow(windowWidth, windowHeight, "ACR", nullptr, nullptr);
  if (window_ == nullptr)
    return false;
...
bool GUI::shouldClose() const { return glfwWindowShouldClose(window_); }

GLFWwindow *GUI::getWindow() const { return window_; }
